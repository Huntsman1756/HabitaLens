...
<gml:FeatureCollection gml:id="ES.SDGC.BU"  xmlns:ad="urn:x-inspire:specification:gmlas:Addresses:3.0" xmlns:base="urn:x-inspire:specification:gmlas:BaseTypes:3.2" xmlns:bu-base="http://inspire.jrc.ec.europa.eu/schemas/bu-base/3.0" xmlns:bu-core2d="http://inspire.jrc.ec.europa.eu/schemas/bu-core2d/2.0" xmlns:bu-ext2d="http://inspire.jrc.ec.europa.eu/schemas/bu-ext2d/2.0" xmlns:cp="urn:x-inspire:specification:gmlas:CadastralParcels:3.0" xmlns:el-bas="http://inspire.jrc.ec.europa.eu/schemas/el-bas/2.0" xmlns:el-cov="http://inspire.jrc.ec.europa.eu/schemas/el-cov/2.0" xmlns:el-tin="http://inspire.jrc.ec.europa.eu/schemas/el-tin/2.0" xmlns:el-vec="http://inspire.jrc.ec.europa.eu/schemas/el-vec/2.0" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gml="http://www.opengis.net/gml/3.2" xmlns:gmlcov="http://www.opengis.net/gmlcov/1.0" xmlns:gn="urn:x-inspire:specification:gmlas:GeographicalNames:3.0" xmlns:gsr="http://www.isotc211.org/2005/gsr" xmlns:gss="http://www.isotc211.org/2005/gss" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:swe="http://www.opengis.net/swe/2.0" xmlns:xlink="http://www.w3.org/1999/xlink"  xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://inspire.jrc.ec.europa.eu/schemas/bu-ext2d/2.0 http://inspire.ec.europa.eu/draft-schemas/bu-ext2d/2.0/BuildingExtended2D.xsd">
  <gml:featureMember>
    <bu-ext2d:Building gml:id="ES.SDGC.BU.1707903VK4810F">
    <gml:boundedBy>
      <gml:Envelope srsName="urn:ogc:def:crs:EPSG::25830">
         <gml:lowerCorner>441669.19 4480587.03</gml:lowerCorner>
         <gml:upperCorner>441706.33 4480608.97</gml:upperCorner>
      </gml:Envelope>
    </gml:boundedBy>
      <bu-core2d:beginLifespanVersion>2002-02-14T00:00:00</bu-core2d:beginLifespanVersion>
      ...
      <bu-core2d:dateOfConstruction>
        <bu-core2d:DateOfEvent>
          <bu-core2d:beginning>1967-01-01T00:00:00</bu-core2d:beginning>
          <bu-core2d:end>1967-01-01T00:00:00</bu-core2d:end>
        </bu-core2d:DateOfEvent>
      </bu-core2d:dateOfConstruction>
      ...
      <bu-core2d:externalReference>
        <bu-core2d:ExternalReference>
          <bu-core2d:informationSystem><![CDATA[https://www1.sedecatastro.gob.es/CYCBienInmueble/OVCListaBienes.aspx?rc1=1707903&rc2=VK4810F]]></bu-core2d:informationSystem>
          <bu-core2d:informationSystemName></bu-core2d:informationSystemName>
          <bu-core2d:reference>1707903VK4810F</bu-core2d:reference>
        </bu-core2d:ExternalReference>
      </bu-core2d:externalReference>
      <bu-core2d:inspireId>
        <base:Identifier>
          <base:localId>1707903VK4810F</base:localId>
          <base:namespace>ES.SDGC.BU</base:namespace>
        </base:Identifier>
      </bu-core2d:inspireId>
      <bu-core2d:addresses xlink:href="http://ovc.catastro.meh.es/INSPIRE/wfsAD.aspx?service=wfs&amp;version=2&amp;request=GetFeature&amp;STOREDQUERIE_ID=GetadByRefcat&amp;refcat=1707903VK4810F&amp;srsname=EPSG::25830"></bu-core2d:addresses>
      <bu-core2d:cadastralParcels xlink:href="http://ovc.catastro.meh.es/INSPIRE/wfsCP.aspx?service=wfs&amp;version=2&amp;request=GetFeature&amp;STOREDQUERIE_ID=GetParcel&amp;refcat=1707903VK4810F&amp;srsname=EPSG::25830"></bu-core2d:cadastralParcels>
      <bu-ext2d:geometry>
       <bu-core2d:BuildingGeometry>
        <bu-core2d:geometry>
         <gml:Surface gml:id="Surface_ES.SDGC.BU.1707903VK4810F" srsName="urn:ogc:def:crs:EPSG::25830">
           <gml:patches>
                <gml:PolygonPatch>
                <gml:exterior>
                    <gml:LinearRing>
                      <gml:posList srsDimension="2" count="19">441686.11 4480590.71 441686.04 4480590.73 441683.65 4480591.25 441669.76 4480594.24 441669.19 4480594.36 441670.77 4480601.69 441672.34 4480608.97 441672.99 4480608.83 441689.81 4480605.2 441703.51 4480602.24 441706.33 4480601.63 441706.13 4480600.71 441705.62 4480598.32 441703.98 4480590.72 441703.51 4480588.56 441703.38 4480587.97 441703.18 4480587.03 441695.13 4480588.77 441686.11 4480590.71</gml:posList>
                    </gml:LinearRing>
                </gml:exterior>
                </gml:PolygonPatch>
              </gml:patches>
      ...
      <bu-ext2d:numberOfBuildingUnits>32</bu-ext2d:numberOfBuildingUnits>
      <bu-ext2d:numberOfDwellings>28</bu-ext2d:numberOfDwellings>
      <bu-ext2d:numberOfFloorsAboveGround xsi:nil="true" nilReason="other:unpopulated"></bu-ext2d:numberOfFloorsAboveGround>
      <bu-ext2d:document>
         <bu-ext2d:Document>
          <bu-ext2d:documentLink>http://ovc.catastro.meh.es/OVCServWeb/OVCWcfLibres/OVCFotoFachada.svc/RecuperarFotoFachadaGet?ReferenciaCatastral=1707903VK4810F</bu-ext2d:documentLink>
      ...
      <bu-ext2d:officialArea>
         <bu-ext2d:OfficialArea>
          ...
          <bu-ext2d:value uom="m2">5879</bu-ext2d:value>
         </bu-ext2d:OfficialArea>
      </bu-ext2d:officialArea>
    </bu-ext2d:Building>
  </gml:featureMember>
